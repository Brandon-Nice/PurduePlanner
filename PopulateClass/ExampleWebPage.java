	...
	public static void main (String[] args)  {
		...
		for (int i = 0; i < 1; i++)
		{
	        ...
	        while (secondOccurenceofDDLABEL != -1)
	        {
		        ...
		        // In the html there there is a number before the words credits. This number
		        // is the number of credits the class is worth
		        int creditsPlace = sub.indexOf("Credits");
		        // Set the section number to what is before the word credits
		        ...
		        // Add the currentClass to the SQL database
