...
/**
 * Created by menane on 11/13/15. More ScheduleView stuff - methods to handle the item details, aka the actual classes
 */
/*
...
public class ItemDetail implements Serializable {
    ...
    private int imgId; //????? not sure what this is for so we may end up deleting this
