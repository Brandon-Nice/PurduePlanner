...
/**
 * Created by menane on 11/13/15. This is an Adapter class that is needed for our Schedule view.
 */
 ...
 */
        ...
        public ExpandableAdapter(List<Category> catList, Context ctx) {
            ...
            this.itemLayoutId = R.layout.schedule_item_layout;
            this.groupLayoutId = R.layout.schedule_group_layout;
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            if (v == null) {
                ...
                v = inflater.inflate(R.layout.schedule_item_layout, parent, false);
            }
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if (v == null) {
                LayoutInflater inflater = (LayoutInflater)ctx.getSystemService
                        (Context.LAYOUT_INFLATER_SERVICE);
                v = inflater.inflate(R.layout.schedule_group_layout, parent, false);
            }
