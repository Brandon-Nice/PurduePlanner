...
public class WeekView extends View {
    ...
    private void init() {
        ...
        mNowLinePaint.setColor(getResources().getColor(R.color.caldroid_light_red));
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        if (mIsFirstDraw){
            ...
            /*if(mNumberOfVisibleDays >= 7 && today.get(Calendar.DAY_OF_WEEK) != mFirstDayOfWeek) {
                int difference = (7 + (today.get(Calendar.DAY_OF_WEEK) - mFirstDayOfWeek)) % 7;
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE", Locale.getDefault()) : new SimpleDateFormat("EEEE", Locale.getDefault());
